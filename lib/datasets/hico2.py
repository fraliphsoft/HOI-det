...
class hico2(imdb):
    ...
    def load_hoi_classes(data_path):
        ...
        with open(os.path.join(data_path, 'hoi_categories.pkl'), 'rb') as f:
            mat_hoi_classes = pickle.load(f, encoding='iso-8859-1')
    ...
    def _load_all_annotations(self):
        ...
        anno_ng_db = pickle.load(open(os.path.join(self._data_path, '%s_NG_HICO_with_pose.pkl' % self._image_set), 'rb'), encoding='iso-8859-1')
        anno_gt_tmp = pickle.load(open(os.path.join(self._data_path, '%s_GT_HICO_with_pose.pkl' % self._image_set), 'rb'), encoding='iso-8859-1')
